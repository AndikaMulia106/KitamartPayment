...
@section('title', 'Kurangi Saldo User')
...
<div class="py-6">
    <div class="max-w-lg mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @endif
        <h2 class="text-2xl font-semibold text-red-700 mb-6">Kurangi Saldo User</h2>
        <form method="POST" action="{{ route('admin.users.min-saldo.process') }}" class="bg-white shadow rounded-lg p-6 border-t-4 border-yellow-400">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-1">Nominal Kurangi Saldo</label>
        ...
        <div class="mt-8">
            <h3 class="text-lg font-semibold text-gray-700 mb-2">Import Kurangi Saldo via Excel</h3>
            ...
            <form method="POST" action="{{ route('admin.users.min-saldo.import') }}" enctype="multipart/form-data" class="bg-yellow-50 p-4 rounded-lg shadow-inner mt-2">
                @csrf
